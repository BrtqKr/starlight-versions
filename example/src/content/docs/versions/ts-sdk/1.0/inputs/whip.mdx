...
sidebar:
  order: 1
slug: ts-sdk/1.0/ts-sdk/inputs/whip
---
...
configured with [`SMELTER_WHIP_WHEP_SERVER_PORT`](/ts-sdk/1.0/deployment/configuration#smelter_whip_whep_server_port).

To connect new input, register it first with [`Smelter.registerInput`](/ts-sdk/1.0/ts-sdk/smelter#registerinput) and
...
* **Type**: [`InputWhipVideoOptions`](/ts-sdk/1.0/ts-sdk/inputs/whip#inputwhipvideooptions)
...
* **Type**: [`InputWhipAudioOptions`](/ts-sdk/1.0/ts-sdk/inputs/whip#inputwhipaudiooptions)
