...
range will be returned from [`registerInput`](/ts-sdk/1.0/ts-sdk/smelter#registerinput).
...
* **Type**: [`InputRtpVideoOptions`](/ts-sdk/1.0/ts-sdk/inputs/rtp#inputrtpvideooptions)
...
* **Type**: [`InputRtpAudioOptions`](/ts-sdk/1.0/ts-sdk/inputs/rtp#inputrtpaudiooptions)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>SDP file</td>
      <td>Use the <code>-sdp\_file FILENAME</code> option when streaming to a smelter to generate an SDP file containing the ASC.</td>
    </tr>
